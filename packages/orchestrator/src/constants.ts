...
export const SCAN_MEMPOOL_CHUNK_INTERVAL_DELAY = 10;
export const SCAN_BLOCK_TXS_INTERVAL_DELAY = 10;
export const SUBMIT_RELAY_RECOVERY_TX_INTERVAL_DELAY = 10;
export const SUBMIT_RELAY_CHECKPOINT_INTERVAL_DELAY = 10;
export const RELAY_DEPOSIT_BLOCKS_SIZE = 50; // 500 blocks
