 ...
 */
export function newWrappedHeader(
  header: BlockHeader,
  height: number
): WrappedHeader;
/**
 ...
 */
export function newHeaderConfig(
  height: number,
  block_header: any
): HeaderConfig;
/**
 ...
 */
export function newRawSignatorySet(
  sigset: SignatorySet,
  bridge_fee_rate: number,
  miner_fee_rate: number,
 ...
 */
export function newSignatorySet(
  hex_script: string,
  numerator: bigint,
  denominator: bigint
): SignatorySet;
...
export interface DepositIndex {
  receiver_index: {
    [key: string]: { [key: string]: { [key: string]: Deposit } };
  };
}
...
export type Payload =
  ...
  | { WitnessProgram: { version: WitnessVersion; program: number[] } };
