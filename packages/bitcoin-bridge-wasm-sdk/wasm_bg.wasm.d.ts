...
export function toBase64BlockHeader(a: number, b: number): void;
export function fromBase64BlockHeader(a: number, b: number, c: number): void;
export function toBinaryBlockHeader(a: number, b: number): void;
export function fromBinaryBlockHeader(a: number, b: number): void;
export function toBase64Script(a: number, b: number): void;
export function fromBase64Script(a: number, b: number, c: number): void;
export function toBinaryScript(a: number, b: number): void;
export function fromBinaryScript(a: number, b: number): void;
export function toBase64PartialMerkleTree(a: number, b: number): void;
export function fromBase64PartialMerkleTree(a: number, b: number, c: number): void;
export function toBinaryPartialMerkleTree(a: number, b: number): void;
export function fromBinaryPartialMerkleTree(a: number, b: number): void;
export function toBase64Transaction(a: number, b: number): void;
export function fromBase64Transaction(a: number, b: number, c: number): void;
export function toBinaryTransaction(a: number, b: number): void;
export function fromBinaryTransaction(a: number, b: number): void;
export function toBase64MerkleBlock(a: number, b: number): void;
export function fromBase64MerkleBlock(a: number, b: number, c: number): void;
export function toBinaryMerkleBlock(a: number, b: number): void;
export function fromBinaryMerkleBlock(a: number, b: number): void;
